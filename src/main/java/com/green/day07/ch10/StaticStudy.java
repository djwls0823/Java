...
public class StaticStudy {
    public static void main(String[] args) {
        ...
        로 해야한다. (각 개체마다 다른 값을 저장 가능하게 하고 싶다면)

        static을 사용할 수 있으면 (위 두줄의 내용과 반대되는 경우) 적극 사용하는걸 추천
        ...
        //이유는 기본 생성자 접근 레벨을 private 세팅했기 때문.
    }
}
...
class NonStaticNumBox {
    ...
    void sum() {
        ...
        //왜 가능하냐 sum()메소드가 호출이 된다는 것은 NonStaticNumberBox가 객체화가 되었다는 것이고
