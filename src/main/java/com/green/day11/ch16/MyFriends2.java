...
public class MyFriends2 {
    public static void main(String[] args) {
        ...
        Friend f2 = new UnivFriend2("SED", "Electronics", "010-2222-2222");
        ...
        //UnivFriend2, CompFriend2, Friend 객체 주소값 둘 다 담을 수 있는 배열
        arr3[0] = obj1;
        arr3[1] = f2;
        arr3[2] = new CompFriend2("YOON", "R&D 1", "02-123-9999");
        arr3[3] = new CompFriend2("PARK", "R&D 2", "02-333-5555");
        arr3[4] = new CompFriend2("KIM", "R&D 3", "02-456-7890");
